...
#define SPAWN_CHILD_WITH_PARAM(bhvParam, modelID, behavior)     BC_B0H(0x29, bhvParam),     BC_W(modelID),     BC_PTR(behavior)
...
#define SET_HITBOX_WITH_OFFSET(radius, height, downOffset)     BC_B(0x2B),     BC_HH(radius, height),     BC_H(downOffset)
...
#define SET_OBJ_PHYSICS(wallHitboxRadius, gravity, bounciness, dragStrength, friction, buoyancy, unused1, unused2)     BC_B(0x30),     BC_HH(wallHitboxRadius, gravity),     BC_HH(bounciness, dragStrength),     BC_HH(friction, buoyancy),     BC_HH(unused1, unused2)
...
const BehaviorScript bhvBigDoor[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_INT(oInteractType, INTERACT_DOOR),
    SCALE(0, 140),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 100),
...
const BehaviorScript bhvBigDoor2[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_INT(oInteractType, INTERACT_DOOR),
    SCALE(0, 150),
...
extern const Collision ccm_seg7_collision_grindel[];
const BehaviorScript bhvGrindel[] = {
    ...
    LOAD_COLLISION_DATA(ccm_seg7_collision_grindel),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 300, /*Gravity*/ -400, /*Bounciness*/ 0, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    DROP_TO_FLOOR(),
    ADD_FLOAT(oPosY, 1),
    SET_HOME(),
    BEGIN_LOOP(),
...
const BehaviorScript bhvFlame2[] = {
    ...
    SET_INTERACT_TYPE(INTERACT_FLAME),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 25, /*Height*/ 12, /*Downwards offset*/ 12),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        ANIMATE_TEXTURE(oAnimState, 2),
...
const BehaviorScript bhvFreezaShipBloxck[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(metal_box_seg8_collision_08024C28),
    SET_FLOAT(oCollisionDistance, 4000),
    SCALE(0,255),
    SET_FLOAT(oDrawingDistance, 65000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};
const BehaviorScript bhvBlockade[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(metal_box_seg8_collision_08024C28),
...
const BehaviorScript bhvKoopaTalk[] = {
    ...
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 90),
    ANIMATE(7),
    SET_HOME(),
...
const BehaviorScript bhvSeesawPlatform[] = {
    ...
    LOAD_COLLISION_DATA(goldseesaw_collision),
    BEGIN_LOOP(),
...
const BehaviorScript bhvHitbox[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 120),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
...
const BehaviorScript bhvHitboxNoReset[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HITBOX(/*Radius*/ 200, /*Height*/ 170),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
    END_LOOP(),
...
const BehaviorScript bhvDolphin[] = {
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    LOAD_ANIMATIONS(oAnimations, dolphin_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(dolphincode),
    END_LOOP(),
};

const BehaviorScript bhvDolphinSwimming[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    SET_FLOAT(oGraphYOffset, 25),
    SET_FLOAT(oDrawingDistance, 32000),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
...
const BehaviorScript bhvRaft[] = {
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(raftcode),
    END_LOOP(),
};

const BehaviorScript bhvJetski[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 150, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    LOAD_COLLISION_DATA(jetski_collision),
    SET_FLOAT(oDrawingDistance, 32000),
    OR_INT(oFlags, OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    BEGIN_LOOP(),
        CALL_NATIVE(jetskiCode),
    END_LOOP(),
};


const BehaviorScript bhvJetski2[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 150, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    LOAD_COLLISION_DATA(jetski2_collision),
    SET_FLOAT(oDrawingDistance, 32000),
    OR_INT(oFlags, OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    BEGIN_LOOP(),
        CALL_NATIVE(jetskiCode),
...
const BehaviorScript bhvPirateship[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SCALE(0,30),
    LOAD_COLLISION_DATA(pirateship_collision),
    SET_FLOAT(oDrawingDistance, 32000),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    BEGIN_LOOP(),
        CALL_NATIVE(pirateshipcode),
    END_LOOP(),
};


const BehaviorScript bhvCannonBall[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_FLOAT(oDrawingDistance, 32000),
    SCALE(0,50),
    BILLBOARD(),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 120),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oDamageOrCoinValue, 2),
    //SET_FLOAT(oGraphYOffset, 25),
    ...
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(cannonball),
    END_LOOP(),
};


const BehaviorScript bhvPirate[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 120),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    ...
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(piratecode),
    END_LOOP(),
};

const BehaviorScript bhvPirateTalk[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_FLOAT(oDrawingDistance, 32000),
...
const BehaviorScript bhvPokemon[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_INT(oIntangibleTimer, 0),
...
const BehaviorScript bhvRoamingPokemon[] ={
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO),
    BEGIN_LOOP(),
        CALL_NATIVE(roamingpokemoncode),
    END_LOOP(),
};
...
const BehaviorScript bhvFountain[] = {
    ...
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BEGIN_LOOP(),
        CALL_NATIVE(fountaincode),
    END_LOOP(),
};


const BehaviorScript bhvIcebeam[] = {
    BEGIN(OBJ_LIST_POLELIKE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INT(oInteractType, INTERACT_POLE),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 435),
    SET_HOME(),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(icebeamcode),
        CALL_NATIVE(bhv_pole_base_loop),
    END_LOOP(),
};

const BehaviorScript bhvTangelaattack[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(tangelaattackcode),
    END_LOOP(),
};
extern const Collision onix_collision[];
const BehaviorScript bhvOnixColl[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_FLOAT(oCollisionDistance, 3000),
    LOAD_COLLISION_DATA(onix_collision),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
extern const Collision gyarados_collision[];
const BehaviorScript bhvGyaradosColl[] = {
    BEGIN(OBJ_LIST_SURFACE),
    SET_FLOAT(oCollisionDistance, 3000),
    LOAD_COLLISION_DATA(gyarados_collision),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
const BehaviorScript bhvNoseguy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_ANIMATIONS(oAnimations, noseguy_anims),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 250),
    ANIMATE(0),
    SET_FLOAT(oGraphYOffset, 63),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(noseguycode),
    END_LOOP(),
};

const BehaviorScript bhvNoseguyRock[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 150),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 150, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 600, /*Unused*/ 0, 0),
    ANIMATE(0),
...
const BehaviorScript bhvRockChase[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_FLOAT(oDrawingDistance, 20000),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_HITBOX(/*Radius*/ 750, /*Height*/ 750),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_FLOAT(oGraphYOffset, 750),
    SET_INT(oDamageOrCoinValue, 8),
    SET_INT(oIntangibleTimer, 0),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(rockchasecode),
    END_LOOP(),
};



const BehaviorScript bhvQuetzal[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_FLOAT(oDrawingDistance, 30000),
    LOAD_ANIMATIONS(oAnimations, quetzl_anims),
    ANIMATE(0),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    BEGIN_LOOP(),
        CALL_NATIVE(quetzalcode),
    END_LOOP(),
};


const BehaviorScript bhvBGMPlayer[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_bgm_player),
    END_LOOP(),
};


const BehaviorScript bhvPirateCross[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_cross),
    END_LOOP(),
};

extern const Collision watergate_collision[];
const BehaviorScript bhvWatergate[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    LOAD_COLLISION_DATA(watergate_collision),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_water_gate),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

const BehaviorScript bhvBigStalk[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oDrawingDistance, 30000),
    SET_FLOAT(oCollisionDistance, 30000),
    LOAD_COLLISION_DATA(stalkbig_collision),
   // CALL_NATIVE(load_object_collision_model_permanent),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

const BehaviorScript bhvMiddleStalk[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oDrawingDistance, 30000),
    SET_FLOAT(oCollisionDistance, 30000),
    LOAD_COLLISION_DATA(stalkmiddle_collision),
   // CALL_NATIVE(load_object_collision_model_permanent),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
const BehaviorScript bhvSmallStalk[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_FLOAT(oDrawingDistance, 30000),
    SET_FLOAT(oCollisionDistance, 30000),
    LOAD_COLLISION_DATA(stalksmall_collision),
    //CALL_NATIVE(load_object_collision_model_permanent),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
const BehaviorScript bhvWaterForce[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(waterforce),
    END_LOOP(),
};

const BehaviorScript bhvHuffPuff[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INTERACT_TYPE(INTERACT_SHOCK),
    LOAD_ANIMATIONS(oAnimations, huffnpuff_anims),
    ANIMATE(0),
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oDamageOrCoinValue, 1),
    SET_INT(oIntangibleTimer, 0),
    ...
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(huffnpuff),
    END_LOOP(),
};

const BehaviorScript bhvHuffPuffBaby[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INTERACT_TYPE(INTERACT_SHOCK),
    SET_INT(oDamageOrCoinValue, 1),
    ...
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(huffnpuffbaby),
    END_LOOP(),
};


const BehaviorScript bhvSleepStarSpawn[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BEGIN_LOOP(),
        CALL_NATIVE(sleepstarspawn),
    END_LOOP(),
};


const BehaviorScript bhvKillwater[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(killwater),
    END_LOOP(),
};


const BehaviorScript bhvFountainstar[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    BEGIN_LOOP(),
        CALL_NATIVE(desertfountain),
    END_LOOP(),
};

//scale with 2nd bparam
extern const struct Animation *const bigblarrgg_anims[];
extern const Collision bigblarrgg_collision[];
const BehaviorScript bhvBigBlargg[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_FLOAT(oDrawingDistance, 30000),
    LOAD_ANIMATIONS(oAnimations, bigblarrgg_anims),
    ANIMATE(0),
    LOAD_COLLISION_DATA(bigblarrgg_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
        CALL_NATIVE(bigblarrgg),
    END_LOOP(),
};

const BehaviorScript bhvMirage[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BEGIN_LOOP(),
        CALL_NATIVE(mirage),
...
extern const struct Animation *const toadmummy_anims[];
const BehaviorScript bhvToadmummy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    ...
    LOAD_ANIMATIONS(oAnimations, toadmummy_anims),
    SET_INT(oIntangibleTimer, 0),
    SET_HITBOX(70, 200),
    SET_INT(oDamageOrCoinValue, 2),
...
extern const struct Animation *const cleopeach_anims[];
const BehaviorScript bhvCleopeach[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, cleopeach_anims),
    ANIMATE(0),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 220),
    SET_INT(oIntangibleTimer, 0),
    CALL_NATIVE(bhv_init_room),
    CALL_NATIVE(bhv_toad_message_init),
    BEGIN_LOOP(),
...
extern const struct Animation *const butler_anims[];
const BehaviorScript bhvButler[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_INT(oInteractionSubtype, INT_SUBTYPE_NPC),
    LOAD_ANIMATIONS(oAnimations, butler_anims),
    ANIMATE(0),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
    SET_INT(oWoodenPostTotalMarioAngle, 0),
    BEGIN_LOOP(),
...
extern const struct Animation *const pharaoh_anims[];
const BehaviorScript bhvPharaoh[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    ...
    LOAD_ANIMATIONS(oAnimations, pharaoh_anims),
    ANIMATE(3),
    SET_HOME(),
    ...
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(pharaohcode),
    END_LOOP(),
};


const BehaviorScript bhvCrystalpillar[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 420),
    SET_INT(oIntangibleTimer, 0),
    SET_INT(oDamageOrCoinValue, 3),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(crystalpillar),
    END_LOOP(),
};
//hide in floor
//attack mario when close with anim
// disappaer until mario far away
//reste back to initial state 
//smallblargg
extern const struct Animation *const smallblargg_anims[];
const BehaviorScript bhvLilBlarrgg[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO  | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    LOAD_ANIMATIONS(oAnimations, smallblargg_anims),
    SET_HITBOX(/*Radius*/ 140, /*Height*/ 200),
    SET_HOME(),
    SET_INT(oDamageOrCoinValue, 2),
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(lilblarrgg),
    END_LOOP(),
};

const BehaviorScript bhvBarrelRoll[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO  | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    ADD_FLOAT(oPosY, 192),
    LOAD_COLLISION_DATA(barrel_collision),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 0, /*Gravity*/ -400, /*Bounciness*/ -10, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(barrelrolling),
    END_LOOP(),
};

const BehaviorScript bhvSurfKoopa[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    ...
    LOAD_ANIMATIONS(oAnimations, koopa_seg6_anims_06011364),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 150, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 600, /*Unused*/ 0, 0),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 90),
    SET_HOME(),
    SCALE(/*Unused*/ 0, /*Field*/ 150),
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(surfyboi),
    END_LOOP(),
};

const BehaviorScript bhvSurfShell[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 90),
...
const BehaviorScript bhvWaypoint[] = {
    BEGIN(OBJ_LIST_GENACTOR),
...
const BehaviorScript bhvBouncyLamp[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
...
const BehaviorScript bhvGongSpawn[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(gong_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};

const BehaviorScript bhvFooDog[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, foodog_anims),
    DROP_TO_FLOOR(),
    SET_HITBOX(/*Radius*/ 110, /*Height*/ 350),
    SET_INT(oInteractType, INTERACT_DAMAGE),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 60, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HOME(),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(foodogcode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

const BehaviorScript bhvPagodagate[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(pagodagate_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(pagodagate),
    END_LOOP(),
};

const BehaviorScript bhvFireLamp[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HITBOX(/*Radius*/ 220, /*Height*/ 135),
    SCALE(0,40),
...
const BehaviorScript bhvChinaBoss[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 400),
    LOAD_ANIMATIONS(oAnimations, chinaboss_anims),
    ANIMATE(3),//walk, fall, spinattack, attack
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ -300, /*Bounciness*/ -20, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HOME(),
    SCALE(0,300),
    SET_FLOAT(oGraphYOffset, -180.f),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(chinabosscode),
    END_LOOP(),
};


const BehaviorScript bhvBell[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 275, /*Height*/ 554, /*Downwards offset*/ 676),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(bellCode),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

extern void dragonbridgecode(void);
const BehaviorScript bhvDragonBridge[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, dragonbridge_anims),
    LOAD_COLLISION_DATA(dragonbridge_collision),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ -70, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_FLOAT(oCollisionDistance, 3000),
    SET_FLOAT(oDrawingDistance, 32000),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(dragonbridgecode),
    END_LOOP(),
};

const BehaviorScript bhvDragonBridge2[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, dragonbridge_anims),
    LOAD_COLLISION_DATA(dragonbridge2_collision),
    SET_FLOAT(oCollisionDistance, 3000),
    SET_FLOAT(oDrawingDistance, 32000),
    ANIMATE(1),
    BEGIN_LOOP(),
...
extern void tikiflying(void);
const BehaviorScript bhvFlyingTiki[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, ( OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, tikiflying_anims),
    LOAD_COLLISION_DATA(tikiflying_collision),
    SET_FLOAT(oCollisionDistance, 600),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_HOME(),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(tikiflying),
    END_LOOP(),
};

extern void tikigoomba(void);
const BehaviorScript bhvTikiGoomba[] = {
    BEGIN(OBJ_LIST_PUSHABLE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, tikigoomba_anims),
    SET_HOME(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 40, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(tikigoomba),
    END_LOOP(),
};

extern void tikispear(void);
const BehaviorScript bhvSpear[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_HOME(),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 50, /*Height*/ 50, /*Downwards offset*/ 50),
    ...
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(tikispear),
    END_LOOP(),
};


extern void sclaetiki(void);
const BehaviorScript bhvTikiGuy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, tikiguy_anims),
    ANIMATE(0),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_HITBOX(/*Radius*/ 80, /*Height*/ 100),
    SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(sclaetiki),
    CALL_NATIVE(bhv_toad_message_init),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_toad_message_loop),
    END_LOOP(),
...
extern void easterhead(void);
const BehaviorScript bhvEasterhead[] = {
    BEGIN(OBJ_LIST_SURFACE),
    ...
    LOAD_COLLISION_DATA(easterhead_collision),
    SET_FLOAT(oCollisionDistance, 1200),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(easterhead),
    END_LOOP(),
};


extern void totemPoleCOde(void);
const BehaviorScript bhvTotemPole[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_COLLISION_DATA(totempole_collision),
    SET_FLOAT(oDrawingDistance, 16000),
    SET_FLOAT(oCollisionDistance, 16000),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(totemPoleCOde),
    END_LOOP(),
};

extern void totemBoss(void);
extern void inittotemBoss(void);
const BehaviorScript bhvTotemBoss[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    CALL_NATIVE(inittotemBoss),
    BEGIN_LOOP(),
        CALL_NATIVE(totemBoss),
    END_LOOP(),
};


extern void totemBosshead(void);
const BehaviorScript bhvTotemBossPart[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 150, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    LOAD_COLLISION_DATA(boss3_collision),
    SET_FLOAT(oDrawingDistance, 16000),
    SET_FLOAT(oCollisionDistance, 2000),
    SCALE(0, 67),
    BEGIN_LOOP(),
        CALL_NATIVE(totemBosshead),
    END_LOOP(),
};


extern void krakenCode(void);
const BehaviorScript bhvKraken[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, kraken_anims),
    LOAD_COLLISION_DATA(kraken_collision),
   // SCALE(0, 50),
    ANIMATE(0),
    SET_FLOAT(oDrawingDistance, 32500),
    SET_FLOAT(oCollisionDistance, 6000),
    BEGIN_LOOP(),
        CALL_NATIVE(krakenCode),
    END_LOOP(),
};

extern void screwcode(void);
...
const BehaviorScript bhvJellyFish[] = {
    ...
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, jellyfish_anims),
    ANIMATE(0),
    SET_HOME(),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 210, /*Height*/ 400, /*Downwards offset*/ 200),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_jrb_floating_box_loop),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
...
extern void deepseaeel(void);
const BehaviorScript bhvBackgroundEel[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, deepeel_anims),
    ANIMATE(2),
    BEGIN_LOOP(),
        CALL_NATIVE(deepseaeel),
    END_LOOP(),
};

extern void snappyeel(void);
const BehaviorScript bhvEelTrap[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    LOAD_ANIMATIONS(oAnimations, deepeel_anims),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 900, /*Height*/ 650, /*Downwards offset*/ 262),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oIntangibleTimer, 0),
    ...
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(snappyeel),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};


extern void angler(void);
const BehaviorScript bhvAnglerFish[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    LOAD_ANIMATIONS(oAnimations, lanternfish_anims),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 900, /*Height*/ 850, /*Downwards offset*/ 300),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 2),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 32000),
...
extern void bhv_air_rocks(void);
...
extern void boneMom(void);
const BehaviorScript bhvBoneFish[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    LOAD_ANIMATIONS(oAnimations, fishbone_anims),
    SET_FLOAT(oDrawingDistance, 32000),
    ANIMATE(0),
    SET_HOME(),
    BEGIN_LOOP(),
...
extern void spidercrab(void);
const BehaviorScript bhvSpiderCrab[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, spidercrab_anims),
    SCALE(0, 350),
    SET_FLOAT(oGraphYOffset, -600),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(spidercrab),
    END_LOOP(),
};
...
const BehaviorScript bhvWobblerock[] = {
    ...
    ADD_FLOAT(oPosY, -50),
    CALL_NATIVE(bhv_platform_normals_init),
    LOAD_COLLISION_DATA(wobble_collision),
    BEGIN_LOOP(),
    CALL_NATIVE(bhv_tilting_inverted_pyramid_loop),
    CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
...
extern void luigiChariot(void);
const BehaviorScript bhvLuigiChariot[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_FLOAT(oDrawingDistance, 32000),
    LOAD_ANIMATIONS(oAnimations, luigichariot_anims),
    SET_HOME(),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(luigiChariot),
    END_LOOP(),
};
extern void yoshiChariot(void);
const BehaviorScript bhvYoshiChariot[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    LOAD_ANIMATIONS(oAnimations, yoshiwings_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshiChariot),
    END_LOOP(),
};

extern void racecheck(void);
const BehaviorScript bhvRaceCheck[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(racecheck),
    END_LOOP(),
};

extern void zeusCode(void);
const BehaviorScript bhvZeus[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 400, /*Height*/ 400, /*Downwards offset*/ 300),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oDrawingDistance, 32000),
    LOAD_ANIMATIONS(oAnimations, zeus_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(zeusCode),
    END_LOOP(),
};
extern void controlHat(void);
const BehaviorScript bhvHatControl[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(controlHat),
    END_LOOP(),
};
...
extern void medusacode(void);
const BehaviorScript bhvMedusa[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 220, /*Downwards offset*/ 0),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, medusa_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(medusacode),
    END_LOOP(),
};

extern void setBoxSize(void);
const BehaviorScript bhvHitBoxMedusa[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HITBOX(/*Radius*/ 150, /*Height*/ 120),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    ...
    BEGIN_LOOP(),
        SET_INT(oInteractStatus, 0),
        CALL_NATIVE(setBoxSize),
    END_LOOP(),
};

extern void olympship(void);
const BehaviorScript bhvOlympShip[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_FLOAT(oCollisionDistance, 5000),
    LOAD_COLLISION_DATA(olympship_collision),
    LOAD_ANIMATIONS(oAnimations, olympship_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(olympship),
    END_LOOP(),
};

extern void medusagate(void);
const BehaviorScript bhvMedusaGate[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_FLOAT(oCollisionDistance, 5000),
    LOAD_COLLISION_DATA(medusagate_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(medusagate),
    END_LOOP(),
};

extern void bacchus(void);
const BehaviorScript bhvBacchus[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 220, /*Downwards offset*/ 0),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, wariobacchus_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(bacchus),
    END_LOOP(),
...
extern void thotcode(void);
const BehaviorScript bhvThot[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 220, /*Downwards offset*/ 0),
    ...
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, thot1_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(thotcode),
    END_LOOP(),
};

const BehaviorScript bhvThot2[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 220, /*Downwards offset*/ 0),
    ...
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, thot2_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(thotcode),
    END_LOOP(),
...
const BehaviorScript bhvThot3[] = {
    ...
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    SET_FLOAT(oGraphYOffset, -220),
    LOAD_ANIMATIONS(oAnimations, thot3_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(thotcode),
    END_LOOP(),
...
extern void zeusCodeBoss(void);
const BehaviorScript bhvZeusBoss[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 400, /*Height*/ 400, /*Downwards offset*/ 300),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, zeus_anims),
    ANIMATE(1),
    BEGIN_LOOP(),
        CALL_NATIVE(zeusCodeBoss),
    END_LOOP(),
};

extern void zeusLighting(void);
const BehaviorScript bhvZeusLightning[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                      | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 180, /*Downwards offset*/ 90),
    SET_INTERACT_TYPE(INTERACT_SHOCK),
    SET_INT(oDamageOrCoinValue, 1),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, lightningball_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(zeusLighting),
    END_LOOP(),
};

extern void yoshiRiding(void);
const BehaviorScript bhvYoshiRiding[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_ACTIVE_FROM_AFAR),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 110, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    LOAD_ANIMATIONS(oAnimations, yoshiwings_anims),
    ANIMATE(0),
    SET_FLOAT(oGraphYOffset, 30),
    BEGIN_LOOP(),
        CALL_NATIVE(yoshiRiding),
    END_LOOP(),
};


extern void namekfloaty(void);
const BehaviorScript bhvNamekPlatform[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
                       SET_HOME(),
    ...
    SET_FLOAT(oDrawingDistance, 32000),
    SET_FLOAT(oCollisionDistance, 5000),
    LOAD_COLLISION_DATA(namekfloaty_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(namekfloaty),
    END_LOOP(),
};


extern void namekelder(void);
const BehaviorScript bhvNamekElder[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                       | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 220, /*Downwards offset*/ 0),
    ...
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, namekElder_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(namekelder),
    END_LOOP(),
};

extern void bamekian(void);
const BehaviorScript bhvNamekian[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, ( OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_INTERACT_TYPE(INTERACT_TEXT),
    SET_INT(oInteractionSubtype, INT_SUBTYPE_NPC),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 60, /*Height*/ 110, /*Downwards offset*/ 0),
    SET_FLOAT(oDrawingDistance, 32000),
    //LOAD_ANIMATIONS(oAnimations, namekElder_anims),
    //ANIMATE(0),
    SET_INT(oWoodenPostTotalMarioAngle, 0),
    BEGIN_LOOP(),
    SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(bamekian),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

extern void waluigitroopa(void);
const BehaviorScript bhvWaluigiTroopa[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_INT(oIntangibleTimer, 0),
    SET_HOME(),
...
extern void kiAttack(void);
const BehaviorScript bhvKiAttack[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                      | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 180, /*Downwards offset*/ 90),
    ...
    SET_INT(oDamageOrCoinValue, 1),
    SET_INT(oIntangibleTimer, 0),
    LOAD_ANIMATIONS(oAnimations, kiattack_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(kiAttack),
    END_LOOP(),
};

extern void troopaattack(void);
const BehaviorScript bhvTroopaAttack[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                      | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(troopaattack),
    END_LOOP(),
};

extern void bulma(void);
const BehaviorScript bhvBulma[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_INT(oIntangibleTimer, 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_FLOAT(oGraphYOffset, -125),
    LOAD_ANIMATIONS(oAnimations, bulma_anims),
    SET_HITBOX(/*Radius*/ 40, /*Height*/ 200),
    BEGIN_LOOP(),
        CALL_NATIVE(bulma),
    END_LOOP(),
};
...
extern void dragonballcode(void);
const BehaviorScript bhvDragonBall[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE
                      | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO),
    ...
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    BEGIN_LOOP(),
        CALL_NATIVE(dragonballcode),
    END_LOOP(),
};

extern void dbzStar(void);
const BehaviorScript bhvDBZStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(dbzStar),
...
const BehaviorScript bhvDragonBallCarry[] = {
    ...
    BEGIN_LOOP(),
        SET_INT(oIntangibleTimer, 0),
        CALL_NATIVE(dragonballpickup),
    END_LOOP(),
};

extern void dbzStar2(void);
const BehaviorScript bhvDBZStar2[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(dbzStar2),
    END_LOOP(),
};


extern void walufreeza(void);
const BehaviorScript bhvWaluFreeza1[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, waluFreezF1_anims),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(walufreeza),
    END_LOOP(),
};


extern void kaioplanet(void);
const BehaviorScript bhvKaioPlanet[] = {
    BEGIN(OBJ_LIST_SURFACE),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_FLOAT(oDrawingDistance, 32000),
    ...
    //LOAD_COLLISION_DATA(namekfloaty_collision),
    BEGIN_LOOP(),
        CALL_NATIVE(kaioplanet),
    END_LOOP(),
};
extern void deathbeam(void);
const BehaviorScript bhvDeathBeam[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    SET_HOME(),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW),
    BEGIN_LOOP(),
        CALL_NATIVE(deathbeam),
    END_LOOP(),
};

extern void smashfreeza(void);
const BehaviorScript bhvWaluFreeza2[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, waluFreezF1_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 200, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 150, /*Height*/ 390, /*Downwards offset*/ 200),
    SET_INTERACT_TYPE(INTERACT_BOUNCE_TOP),
    SET_INT(oDamageOrCoinValue, 1),
    SET_HOME(),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(smashfreeza),
    END_LOOP(),
};

extern void bounceshroom(void);
const BehaviorScript bhvBounceShroom[] = {
    ...
    BEGIN_LOOP(),
        CALL_NATIVE(bounceshroom),
    END_LOOP(),
};

extern void latebunny(void);
const BehaviorScript bhvLateBunny[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, latebunny_anims),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 115, /*Gravity*/ -200, /*Bounciness*/ -50, /*Drag strength*/ 1000, /*Friction*/ 1000, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 150, /*Height*/ 390, /*Downwards offset*/ 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(latebunny),
    END_LOOP(),
};

extern void dinnerbunny(void);
const BehaviorScript bhvDinnerBunny[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, latebunny_anims),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 150, /*Height*/ 390, /*Downwards offset*/ 0),
    ...
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(dinnerbunny),
    END_LOOP(),
};

extern void madhatcode(void);
const BehaviorScript bhvMadHat[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, madHat_anims),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 150, /*Height*/ 390, /*Downwards offset*/ 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    ANIMATE(0),
    BEGIN_LOOP(),
        CALL_NATIVE(madhatcode),
    END_LOOP(),
};

const BehaviorScript bhvBreakableCannonWall[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(breakwall_collision),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 500, /*Height*/ 800, /*Downwards offset*/ 400),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_wf_breakable_wall_loop),
        CALL_NATIVE(load_object_collision_model),
...
extern void breakCannon(void);
const BehaviorScript bhvShipCannon[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(breakCannon),
    END_LOOP(),
};

extern void kingpiratecode(void);
const BehaviorScript bhvKingPirate[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bombpirate_anims),
    ANIMATE(0),
    SET_FLOAT(oDrawingDistance, 20000),
    SET_HITBOX(/*Radius*/ 100, /*Height*/ 100),
    SET_INT(oHealth, 3),
    BEGIN_LOOP(),
        CALL_NATIVE(kingpiratecode),
    END_LOOP(),
};
extern void cannonking(void);
const BehaviorScript bhvPirateCannon[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(cannonking),
    END_LOOP(),
};
extern void cannonomb(void);
const BehaviorScript bhvCannonOmb[] = {
    BEGIN(OBJ_LIST_DESTRUCTIVE),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bobomb_seg8_anims_0802396C),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 115, /*Gravity*/ -200, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 40, /*Height*/ 70, /*Downwards offset*/ 0),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    ANIMATE(0),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(cannonomb),
    END_LOOP(),
};

extern void evilShark(void);
const BehaviorScript bhvEvilShark[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 400, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    LOAD_ANIMATIONS(oAnimations, monster_anims),
    SET_FLOAT(oDrawingDistance, 32000),
    ANIMATE(0),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(evilShark),
    END_LOOP(),
};


extern void pirateskel(void);
const BehaviorScript bhvPirateSkeleton[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO)),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 115, /*Gravity*/ -400, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    SET_INT(oDamageOrCoinValue, 3),
    SET_INT(oInteractType, INTERACT_DAMAGE),
    LOAD_ANIMATIONS(oAnimations, pirateskeleton_anims),
    SET_HITBOX_WITH_OFFSET(/*Radius*/ 100, /*Height*/ 250, /*Downwards offset*/ 0),
    SET_HOME(),
    BEGIN_LOOP(),
        CALL_NATIVE(pirateskel),
    SET_INT(oIntangibleTimer, 0),
        SET_INT(oInteractStatus, 0),
    END_LOOP(),
};

extern void toad_statue(void);
const BehaviorScript bhvToadStatue[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, toad_seg6_anims_0600FB58),
    ANIMATE(6),
    ...
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(toad_statue),
    END_LOOP(),
};


extern void wingocode(void);
const BehaviorScript bhvWingo[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    SET_INTERACT_TYPE(INTERACT_IGLOO_BARRIER),
    SET_HITBOX(/*Radius*/ 120, /*Height*/ 160),
    LOAD_ANIMATIONS(oAnimations, wingo_anims),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(wingocode),
    END_LOOP(),
};


const BehaviorScript bhvStingby[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, stingby_anims),
    ANIMATE(0),
    SET_HOME(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 50, /*Gravity*/ 0, /*Bounciness*/ 0, /*Drag strength*/ 0, /*Friction*/ 1000, /*Buoyancy*/ 600, /*Unused*/ 0, 0),
    CALL_NATIVE(bhv_init_room),
...
extern void alicethwomp(void);
const BehaviorScript bhvAliceThwomp[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_COLLISION_DATA(alicethwomp_collision),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    SET_HOME(),
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 100, /*Gravity*/ -400, /*Bounciness*/ -50, /*Drag strength*/ 0, /*Friction*/ 0, /*Buoyancy*/ 200, /*Unused*/ 0, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(alicethwomp),
        CALL_NATIVE(load_object_collision_model),
    END_LOOP(),
};


extern void thwomptoad(void);
const BehaviorScript bhvThwompToad[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, toad_seg6_anims_0600FB58),
    ANIMATE(6),
    ...
    CALL_NATIVE(bhv_toad_message_init),
    BEGIN_LOOP(),
        CALL_NATIVE(thwomptoad),
        CALL_NATIVE(bhv_toad_message_loop),
    END_LOOP(),
};


extern void wiggleralice(void);
const BehaviorScript bhvWigglerAlice[] = {
    BEGIN(OBJ_LIST_SURFACE),
    LOAD_ANIMATIONS(oAnimations, wigglerSegment_anims),
    OR_INT(oFlags, (OBJ_FLAG_ACTIVE_FROM_AFAR | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO| OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(wiggleralice),
    END_LOOP(),
};

extern void beestar(void);
const BehaviorScript bhvBeeStar[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_PERSISTENT_RESPAWN | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(beestar),
...
extern void snakepathanims(void);
const BehaviorScript bhvSnakePathAnims[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    BEGIN_LOOP(),
        CALL_NATIVE(snakepathanims),
    END_LOOP(),
};



extern void toadlawyer(void);
const BehaviorScript bhvToadLawyer[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    ...
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(toadlawyer),
    END_LOOP(),
};

const BehaviorScript bhvTreasureDoor[] = { //explodable
    BEGIN(OBJ_LIST_SURFACE),
...
extern void tutorialGuy(void);
const BehaviorScript bhvTutorialGuy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_HOLDABLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE)),
    LOAD_ANIMATIONS(oAnimations, bobomb_seg8_anims_0802396C),
    SET_INTERACT_TYPE(INTERACT_TEXT),
...
extern void ResetInteraction(void);
const BehaviorScript bhvEmptyHitbox[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE),
    SET_INT(oIntangibleTimer, 0),
    BEGIN_LOOP(),
        CALL_NATIVE(ResetInteraction),
    END_LOOP(),
};
extern void retropiranha(void);
const BehaviorScript bhvRetroPiranha[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    BEGIN_LOOP(),
        CALL_NATIVE(retropiranha),
    END_LOOP(),
};
#define TICK(a) BEGIN_LOOP(),CALL_NATIVE(a), END_LOOP()
#define SET_GRAPH_PARAMETERS(a, b, c, d) OR_INT(oFlags, 0)
...
const ConstructionScript bhvWallSword[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    ...
    SET_OBJ_PHYSICS(/*Wall hitbox radius*/ 30, /*Gravity*/ 0, /*Bounciness*/ 0,
                    /*Drag strength*/ 0, /*Friction*/ 1000, /*Buoyancy*/ 0, /*Unused*/ 0, 0),
    SET_INTERACT_TYPE(INTERACT_DAMAGE),
    SET_INT(oDamageOrCoinValue, 3),
    SET_HITBOX(/*Radius*/ 180, /*Height*/ 20),
    SET_GRAPH_PARAMETERS(220, 0, 0, 0), 
    TICK(wallsword),
};
...
const ConstructionScript bhvShyGuySays[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    ...
    SET_GRAPH_PARAMETERS(128, SHADOW_CIRCLE_4_VERTS, 0x35, 90), 
    SCALE(/*Unused*/ 0, /*Field*/ 150),
    TICK(shyguysays),
};
...
const ConstructionScript bhvShyGuyBlock[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_FLOAT(oCollisionDistance, 32000),
    SET_GRAPH_PARAMETERS(303, 0, 0, 0), 
    TICK(shyguyblock),
};
...
const ConstructionScript bhvPushShelf[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_GRAPH_PARAMETERS(734, 0, 0, 0), 
    SET_HOME(),
    TICK(pushthingy2),
};
...
const ConstructionScript bhvJellyBlock[] = {
    ...
    SET_FLOAT(oCollisionDistance, 6000),
    SET_HOME(),
    LOAD_ANIMATIONS(oAnimations, jellyblock_anims),
    ANIMATE(0),
    SET_GRAPH_PARAMETERS(600, 0, 0, 0), 
    TICK(jellyblock),
};


const ConstructionScript bhvFlameSmall[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BILLBOARD(),
    SCALE(/*Unused*/ 0, /*Field*/ 70),
    SET_GRAPH_PARAMETERS(28, 0, 0, 0),
    BEGIN_LOOP(),
    END_LOOP(),
};
const ConstructionScript bhvFlameMedium[] = {
    BEGIN(OBJ_LIST_LEVEL),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    BILLBOARD(),
    SCALE(/*Unused*/ 0, /*Field*/ 250),
    SET_GRAPH_PARAMETERS(100, 0, 0, 0),
    BEGIN_LOOP(),
    END_LOOP(),
};
...
const ConstructionScript bhvDestroyBarrel[] = {
    ...
    SET_HOME(),
    SET_GRAPH_PARAMETERS(241, SHADOW_CIRCLE_4_VERTS, 0xb4, 250), 
    CALL_NATIVE(SetBarrelColor),
    CALL_NATIVE(cur_obj_update_floor_height),
    TICK(destroybarrelcode),
};
...
const ConstructionScript bhvCrumbleBridge[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_FLOAT(oDrawingDistance, 32000),
    SET_GRAPH_PARAMETERS(224, 0, 0, 0), 
    TICK(crumblebridge),
};
...
const ConstructionScript bhvBooGuyPainting[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HOME(),
    SET_GRAPH_PARAMETERS(105, 0, 0, 0), 
    TICK(booGuyPainting),
};
...
const ConstructionScript bhvBooBarrel[] = {
    ...
    SET_HOME(),
    CALL_NATIVE(cur_obj_update_floor_height),
    SET_GRAPH_PARAMETERS(606, SHADOW_CIRCLE_4_VERTS, 0xb4, 250), 
    TICK(boobarrel),
};

const ConstructionScript bhvYoshiCoin[] = {
    BEGIN(OBJ_LIST_LEVEL),
    // Yellow coin - common:
    BILLBOARD(),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_DIST_TO_MARIO | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    CALL_NATIVE(bhv_yellow_coin_init),
    SET_MODEL(MODEL_BLUE_COIN),
    SET_INT(oDamageOrCoinValue, 5),
    BEGIN_LOOP(),
        CALL_NATIVE(bhv_yellow_coin_loop),
    END_LOOP(),
...
const ConstructionScript bhvShyGuyCaptain[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    ...
    SET_GRAPH_PARAMETERS(298, SHADOW_CIRCLE_4_VERTS, 0x4f, 100), 
    TICK(shyguycpt),
};
...
const ConstructionScript bhvMoveCrate[] = {
    ...
    OR_INT(oFlags, (OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HOME(),
    SET_GRAPH_PARAMETERS(491, 0, 0, 0), 
    TICK(movecratecode),
};
...
const ConstructionScript bhvGhostPlatform[] = {
    ...
    SET_HOME(),
    SET_GRAPH_PARAMETERS(258, SHADOW_SQUARE_PERMANENT, 0xB4, 614), 
    TICK(ghostplatform),
};

extern void ghostLantern(void);
const ConstructionScript bhvGhostLantern[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, (OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HOME(),
    SET_GRAPH_PARAMETERS(339, 0, 0, 0), 
    TICK(ghostLantern),
};

extern void booGuy(void);
const ConstructionScript bhvBooGuy[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    // Boo - common:
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO
                    | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO)),
    SET_HOME(),
    SET_INTERACT_TYPE(INTERACT_BOUNCE_TOP),
    SET_INT(oDamageOrCoinValue, 2),
    ...
    SET_GRAPH_PARAMETERS(95, SHADOW_CIRCLE_4_VERTS, 0x35, 90), 
    TICK(booGuy),
};
...
const ConstructionScript bhvYoshiBubble[] = {
    BEGIN(OBJ_LIST_DEFAULT),
    OR_INT(oFlags, OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_COMPUTE_DIST_TO_MARIO),
    SET_GRAPH_PARAMETERS(50, 0, 0, 0), 
    BILLBOARD(),
    CALL_NATIVE(SleepBubbleInit),
    TICK(SleepBubble),
};
...
const ConstructionScript bhvMadPiano[] = {
    BEGIN(OBJ_LIST_GENACTOR),
    OR_INT(oFlags, (OBJ_FLAG_COMPUTE_ANGLE_TO_MARIO
                    | OBJ_FLAG_UPDATE_GFX_POS_AND_ANGLE | OBJ_FLAG_SET_FACE_YAW_TO_MOVE_YAW)),
    LOAD_ANIMATIONS(oAnimations, MadPiano_anims),
    SET_INT(oDamageOrCoinValue, 3),
    ANIMATE(0),

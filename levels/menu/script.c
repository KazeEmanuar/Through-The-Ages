...
extern const GeoLayout geo_menu_act_selector_strings2[];

const LevelScript level_main_menu_entry_2Jump[] = {
    /*42*/ EXIT(),
};
//crashes if no early exit kazetodo
const LevelScript level_main_menu_entry_2[] = {
    /*0*/ CALL(/*arg*/ 0, /*func*/ lvl_set_current_level),
  //  /*42*/ EXIT(),
    /*2*/ JUMP_IF(/*op*/ OP_EQ, /*arg*/ 0, level_main_menu_entry_2Jump),
    /*5*/ INIT_LEVEL(),
    ...
    /*25*/ FREE_LEVEL_POOL(),
    /*26*/ LOAD_AREA(/*area*/ 2),   //loading area 2 crashes kazetodo

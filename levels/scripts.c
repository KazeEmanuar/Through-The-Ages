...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(0xf0,                          staryu_geo),
    LOAD_MODEL_FROM_GEO(0xf1,                          weezing_geo),
    LOAD_MODEL_FROM_GEO(0xf2,                          tangela_geo),
    LOAD_MODEL_FROM_GEO(0xf3,                          haunter_geo),
    LOAD_MODEL_FROM_GEO(0xf4,                          onix_geo),
    LOAD_MODEL_FROM_GEO(0xf5,                          primeape_geo),
    LOAD_MODEL_FROM_GEO(0xf6,                          golem_geo),
    LOAD_MODEL_FROM_GEO(0xf7,                          articuno_geo),
    LOAD_MODEL_FROM_GEO(0xf8,                          magnemite_geo),
    LOAD_MODEL_FROM_GEO(0xf9,                          gyarados_geo),
    LOAD_MODEL_FROM_GEO(0xfa,                          hypno_geo),
    LOAD_MODEL_FROM_GEO(0xfd,                          tangelaattack_geo),
    LOAD_MODEL_FROM_GEO(0xfe,                          icebeam),
    LOAD_MODEL_FROM_GEO(0xff,                          staryufountain_geo),
    LOAD_MODEL_FROM_GEO(0xfc,              sleepcloud_geo), // repeated
    FREE_LEVEL_POOL(),

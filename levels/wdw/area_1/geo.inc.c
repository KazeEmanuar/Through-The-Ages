...
const GeoLayout wdw_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -10456, -4374, 16092),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 100),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_FORCE, wdw_dl_BACKGROUND_mesh_layer_0),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_ALPHA, wdw_dl_Circle_001_mesh_layer_4),
		GEO_ASM(0, background_translate),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wdw_dl_Circle_003_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 1421, 815, -1462, wdw_dl_Circle_004_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 1421, 815, -1462, wdw_dl_Circle_005_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wdw_dl_Cube_012_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, wdw_dl_Cube_012_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};

...
const GeoLayout wdw_area_5_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, wdw_dl_Circle_033_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wdw_dl_Cube_004_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, wdw_dl_Cube_004_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout wdw_area_5[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, -47855, 0, 23736, -47855, -1, 23736, geo_camera_main),
				GEO_OPEN_NODE(),
					GEO_BRANCH(1, wdw_area_5_geo),
					GEO_RENDER_OBJ(),

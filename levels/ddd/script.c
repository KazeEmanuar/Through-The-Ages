...
const LevelScript level_ddd_entry[] = {
	...
	AREA(1, ddd_area_1),
		...
		WARP_NODE(0x0B, LEVEL_DDD, 0x02, 0x0A, WARP_CHECKPOINT),
		...
		WARP_NODE(0x1B, LEVEL_DDD, 0x03, 0x0A, WARP_CHECKPOINT),
		...
		OBJECT_WITH_ACTS(0x36, -1580, 474, -7355, 0, 170, 0, 0x00000000, bhvLuigiChariot, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_6),
		...
		OBJECT_WITH_ACTS(0, -4931, 1545, -17858, 0, 170, 0, 0x00010000, bhvRaceCheck, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_6),
		OBJECT_WITH_ACTS(0, -1710, 542, -6933, 0, 170, 0, 0x10020000, bhvRaceCheck, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_6),

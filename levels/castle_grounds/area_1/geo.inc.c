...
const GeoLayout castle_grounds_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, castle_grounds_dl_Mansion_001_mesh_layer_6),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 15, -491, -994, castle_grounds_dl_world_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 15, -491, -994, castle_grounds_dl_world_001_mesh_layer_4),
		GEO_OPEN_NODE(),

...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		OBJECT(0, -602, -456, 2640, 0, 177, 0, 0x00E90000, bhvAirborneStarCollectWarp),
		OBJECT(0, -561, -456, 2640, 0, 177, 0, 0x00D90000, bhvAirborneDeathWarp),
		...
		OBJECT(0x37, 6373, -1103, 6239, 0, -93, 0, 0x00010000, bhvRaft),
		OBJECT(MODEL_BOBOMB_BUDDY, -193, -923, 7346, 0, -180, 0, 0x00010000, bhvTutorialGuy),
		OBJECT(0x39, -8813, -1103, 2993, 0, 95, 0, 0x00010000, bhvPirateship),

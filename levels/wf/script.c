...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, -706, -1063, 3937, 0, 105, 0, (0x2A << 16), bhvAirborneWarp),
		...
		OBJECT(0, -9035, 1773, -596, 0, 0, 0, (4 << 24), bhvHiddenRedCoinStar),
	...
	AREA(3, wf_area_3),
		...
		WARP_NODE(0xf0, LEVEL_CASTLE_GROUNDS, 0x01, 0xe2, WARP_NO_CHECKPOINT),
		WARP_NODE(0xf1, LEVEL_CASTLE_GROUNDS, 0x01, 0xd2, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_WF, 0x01, 0x2A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_WOODEN_SIGNPOST, 9826, -2557, 3245, 0, 90, 0, 0x008A0000, bhvMessagePanel),
		OBJECT(MODEL_TREASURE_CHEST_BASE, -68, -2543, -1441, 0, 90, 0, (5 << 24), bhvBetaChestBottom),
		OBJECT(MODEL_TREASURE_CHEST_BASE, -805, -2610, 4964, 0, 90, 0, (5 << 24), bhvBetaChestBottom),
		OBJECT(MODEL_TREASURE_CHEST_BASE, -8680, -2629, 2467, 0, 90, 0, (5 << 24), bhvBetaChestBottom),
		OBJECT(MODEL_TREASURE_CHEST_BASE, -5912, -5419, 2353, 0, 90, 0, (5 << 24), bhvBetaChestBottom),
		OBJECT(0, 12141, -2405, 2621, 0, -90, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_TREASURE_CHEST_BASE, 10979, -2509, 1945, 0, 73, 0, (5 << 24), bhvBetaChestBottom),
		OBJECT(0x37, 5252, -10014, 1886, 0, 73, 0, 0x00000000, bhvEvilShark),
		OBJECT(0x37, -4525, -8711, 2716, 0, 73, 0, 0x00000000, bhvEvilShark),
		OBJECT(0, 12354, -1805, 2613, 0, -90, 0, (0x0B << 16), bhvWarp),

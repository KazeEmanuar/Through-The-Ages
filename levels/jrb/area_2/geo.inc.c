...
const GeoLayout jrb_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, 459, -1169, -383, jrb_dl_area2mainhallalpha_mesh_layer_6),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, jrb_dl_area2mainhallalpha_mesh_layer_4),
		GEO_CLOSE_NODE(),

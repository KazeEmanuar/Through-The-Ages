...
#define DECLARE_SEGMENT(name)     extern u8 _##name##SegmentRomStart[];     extern u8 _##name##SegmentRomEnd[];

#define DECLARE_ACTOR_SEGMENT(name)     DECLARE_SEGMENT(name##_mio0)     DECLARE_SEGMENT(name##_geo)

#define DECLARE_LEVEL_SEGMENT(name)     DECLARE_SEGMENT(name)     DECLARE_SEGMENT(name##_segment_7)

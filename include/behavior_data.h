...
extern const BehaviorScript bhvBouncyLamp[];
extern const BehaviorScript bhvWaypoint[];
extern const BehaviorScript bhvSurfShell[];
extern const BehaviorScript bhvSurfKoopa[];
extern const BehaviorScript bhvBarrelRoll[];
extern const BehaviorScript bhvKoopaTalk[];
extern const BehaviorScript bhvLilBlarrgg[];
extern const BehaviorScript bhvCrystalpillar[];
extern const BehaviorScript bhvPharaoh[];
extern const BehaviorScript bhvButler[];
extern const BehaviorScript bhvCleopeach[];
extern const BehaviorScript bhvToadmummy[];
extern const BehaviorScript bhvMirage[];
extern const BehaviorScript bhvBigBlargg[];
...
extern const BehaviorScript bhvBigDoor[];
extern const BehaviorScript bhvBigDoor2[];
...
extern const BehaviorScript bhvBlockade[];
...
extern const BehaviorScript bhvPanther[];
extern const BehaviorScript bhvHitbox[];
extern const BehaviorScript bhvHitboxNoReset[];
extern const BehaviorScript bhvDolphin[];
extern const BehaviorScript bhvDolphinSwimming[];
extern const BehaviorScript bhvRaft[];
extern const BehaviorScript bhvJetski[];
extern const BehaviorScript bhvJetski2[];
extern const BehaviorScript bhvPirateship[];
extern const BehaviorScript bhvCannonBall[];
extern const BehaviorScript bhvPirate[];
extern const BehaviorScript bhvPirateTalk[];
extern const BehaviorScript bhvPokemon[];
extern const BehaviorScript bhvRoamingPokemon[];
extern const BehaviorScript bhvFountain[];
extern const BehaviorScript bhvIcebeam[];
extern const BehaviorScript bhvTangelaattack[];
extern const BehaviorScript bhvOnixColl[];
extern const BehaviorScript bhvGyaradosColl[];
extern const BehaviorScript bhvNoseguy[];
extern const BehaviorScript bhvNoseguyRock[];
extern const BehaviorScript bhvFliptile[];
extern const BehaviorScript bhvRockChase[];
extern const BehaviorScript bhvQuetzal[];
extern const BehaviorScript bhvBGMPlayer[];
extern const BehaviorScript bhvPirateCross[];
extern const BehaviorScript bhvWatergate[];
extern const BehaviorScript bhvBigStalk[];
extern const BehaviorScript bhvMiddleStalk[];
extern const BehaviorScript bhvSmallStalk[];
extern const BehaviorScript bhvWaterForce[];
extern const BehaviorScript bhvHuffPuff[];
extern const BehaviorScript bhvHuffPuffBaby[];
extern const BehaviorScript bhvHammer[];
extern const BehaviorScript bhvSleepStarSpawn[];
extern const BehaviorScript bhvKillwater[];
extern const BehaviorScript bhvFountainstar[];
extern const BehaviorScript bhvGong[];
extern const BehaviorScript bhvGongSpawn[];
extern const BehaviorScript bhvFooDog[];
extern const BehaviorScript bhvPagodagate[];
extern const BehaviorScript bhvFireLamp[];
extern const BehaviorScript bhvChinaBoss[];
extern const BehaviorScript bhvBell[];
extern const BehaviorScript bhvDragonBridge[];
extern const BehaviorScript bhvDragonBridge2[];
extern const BehaviorScript bhvTextureAnims[];
extern const BehaviorScript bhvFlyingTiki[];
extern const BehaviorScript bhvTikiGoomba[];
extern const BehaviorScript bhvSpear[];
extern const BehaviorScript bhvTikiGuy[];
extern const BehaviorScript bhvEasterhead[];
extern const BehaviorScript bhvTotemPole[];
extern const BehaviorScript bhvTotemBoss[];
extern const BehaviorScript bhvTotemBossPart[];
extern const BehaviorScript bhvKraken[];
extern const BehaviorScript bhvScrew[];
extern const BehaviorScript bhvJellyFish[];
extern const BehaviorScript bhvBackgroundEel[];
extern const BehaviorScript bhvEelTrap[];
extern const BehaviorScript bhvAnglerFish[];
extern const BehaviorScript bhvAirrocks[];
extern const BehaviorScript bhvBoneFish[];
extern const BehaviorScript bhvSpiderCrab[];
extern const BehaviorScript bhvWobblerock[];
extern const BehaviorScript bhvLuigiChariot[];
extern const BehaviorScript bhvYoshiChariot[];
extern const BehaviorScript bhvRaceCheck[];
extern const BehaviorScript bhvZeus[];
extern const BehaviorScript bhvHatControl[];
extern const BehaviorScript bhvLightning[];
extern const BehaviorScript bhvMedusa[];
extern const BehaviorScript bhvHitBoxMedusa[];
extern const BehaviorScript bhvOlympShip[];
extern const BehaviorScript bhvMedusaGate[];
extern const BehaviorScript bhvBacchus[];
extern const BehaviorScript bhvThot[];
extern const BehaviorScript bhvThot2[];
extern const BehaviorScript bhvThot3[];
extern const BehaviorScript bhvZeusBoss[];
extern const BehaviorScript bhvZeusLightning[];
extern const BehaviorScript bhvYoshiRiding[];
extern const BehaviorScript bhvNamekPlatform[];
extern const BehaviorScript bhvNamekElder[];
extern const BehaviorScript bhvNamekian[];
extern const BehaviorScript bhvWaluigiTroopa[];
extern const BehaviorScript bhvKiAttack[];
extern const BehaviorScript bhvTroopaAttack[];
extern const BehaviorScript bhvBulma[];
extern const BehaviorScript bhvDragonBall[];
extern const BehaviorScript bhvDBZStar[];
extern const BehaviorScript bhvDragonBallCarry[];
extern const BehaviorScript bhvFreezaShipBloxck[];
extern const BehaviorScript bhvDBZStar2[];
extern const BehaviorScript bhvWaluFreeza1[];
extern const BehaviorScript bhvKaioPlanet[];
extern const BehaviorScript bhvDeathBeam[];
extern const BehaviorScript bhvWaluFreeza2[];
extern const BehaviorScript bhvBounceShroom[];
extern const BehaviorScript bhvLateBunny[];
extern const BehaviorScript bhvBreakableCannonWall[];
extern const BehaviorScript bhvShipCannon[];
extern const BehaviorScript bhvKingPirate[];
extern const BehaviorScript bhvPirateCannon[];
extern const BehaviorScript bhvCannonOmb[];
extern const BehaviorScript bhvEvilShark[];
extern const BehaviorScript bhvPirateSkeleton[];
extern const BehaviorScript bhvDinnerBunny[];
extern const BehaviorScript bhvMadHat[];
extern const BehaviorScript bhvToadStatue[];
extern const BehaviorScript bhvWingo[];
extern const BehaviorScript bhvStingby[];
extern const BehaviorScript bhvAliceThwomp[];
extern const BehaviorScript bhvThwompToad[];
extern const BehaviorScript bhvWigglerAlice[];
extern const BehaviorScript bhvBeeStar[];
extern const BehaviorScript bhvSnakePathAnims[];
...
extern const BehaviorScript bhvSleepCloud[];
extern const BehaviorScript bhvEmptyHitbox[];
extern const BehaviorScript bhvRetroPiranha[];
...
extern const BehaviorScript bhvDoubleDoor[];
...
extern const BehaviorScript bhvCatchnet[];
...
extern const BehaviorScript bhvYoshiCoin[];
extern const BehaviorScript bhvThePlank[];

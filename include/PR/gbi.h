 ...
 * DMA macros
 */
#define	gDma0p(pkt, c, s, l)						{										Gfx *_g = (Gfx *)(pkt);																_g->words.w0 = _SHIFTL((c), 24, 8) | _SHIFTL((l), 0, 24);		_g->words.w1 = (uintptr_t)(s);				}

#define	gsDma0p(c, s, l)						{{										_SHIFTL((c), 24, 8) | _SHIFTL((l), 0, 24), (uintptr_t)(s)	}}

#define	gDma1p(pkt, c, s, l, p)						{										Gfx *_g = (Gfx *)(pkt);																_g->words.w0 = (_SHIFTL((c), 24, 8) | _SHIFTL((p), 16, 8) |				_SHIFTL((l), 0, 16));					_g->words.w1 = (uintptr_t)(s);				}

#define	gsDma1p(c, s, l, p)						{{										(_SHIFTL((c), 24, 8) | _SHIFTL((p), 16, 8) | 				 _SHIFTL((l), 0, 16)), 						        (uintptr_t)(s)						}}

#define	gDma2p(pkt, c, adrs, len, idx, ofs)				{										Gfx *_g = (Gfx *)(pkt);							_g->words.w0 = (_SHIFTL((c),24,8)|_SHIFTL(((len)-1)/8,19,5)|				_SHIFTL((ofs)/8,8,8)|_SHIFTL((idx),0,8));		_g->words.w1 = (uintptr_t)(adrs);				}
#define	gsDma2p(c, adrs, len, idx, ofs)					{{										(_SHIFTL((c),24,8)|_SHIFTL(((len)-1)/8,19,5)|				 _SHIFTL((ofs)/8,8,8)|_SHIFTL((idx),0,8)),			        (uintptr_t)(adrs)						}}
 ...
 *        +-+---+-----------------------------+
 */
# define	gSPVertex(pkt, v, n, v0)				{										Gfx *_g = (Gfx *)(pkt);							_g->words.w0 =								  _SHIFTL(G_VTX,24,8)|_SHIFTL((n),12,8)|_SHIFTL((v0)+(n),1,7);		_g->words.w1 = (uintptr_t)(v);				}
# define	gsSPVertex(v, n, v0)					{{										(_SHIFTL(G_VTX,24,8)|_SHIFTL((n),12,8)|_SHIFTL((v0)+(n),1,7)),	        (uintptr_t)(v)						}}
...
#define	gImmp1(pkt, c, p0)						{										Gfx *_g = (Gfx *)(pkt);																_g->words.w0 = _SHIFTL((c), 24, 8);					_g->words.w1 = (uintptr_t)(p0);				}
...
#define	gImmp21(pkt, c, p0, p1, dat)					{										Gfx *_g = (Gfx *)(pkt);																_g->words.w0 = (_SHIFTL((c), 24, 8)  | _SHIFTL((p0), 8, 16) |				_SHIFTL((p1), 0, 8));					_g->words.w1 = (uintptr_t) (dat);				}
...
#else
#define gSP2Triangles(pkt, v00, v01, v02, flag0, v10, v11, v12, flag1)	{										gSP1Triangle(pkt, v00, v01, v02, flag0);				gSP1Triangle(pkt, v10, v11, v12, flag1);			}
#define gsSP2Triangles(v00, v01, v02, flag0, v10, v11, v12, flag1)		gsSP1Triangle(v00, v01, v02, flag0),					gsSP1Triangle(v10, v11, v12, flag1)
...
#define	gSPBranchLessZrg(pkt, dl, vtx, zval, near, far, flag, zmin, zmax) {										Gfx *_g = (Gfx *)(pkt);							_g->words.w0 = _SHIFTL(G_RDPHALF_1,24,8);				_g->words.w1 = (uintptr_t)(dl);					_g = (Gfx *)(pkt);							_g->words.w0 = (_SHIFTL(G_BRANCH_Z,24,8)|					        _SHIFTL((vtx)*5,12,12)|_SHIFTL((vtx)*2,0,12));		_g->words.w1 = G_DEPTOZSrg(zval, near, far, flag, zmin, zmax);	}

#define	gsSPBranchLessZrg(dl, vtx, zval, near, far, flag, zmin, zmax)	      {{	_SHIFTL(G_RDPHALF_1,24,8),					      	(uintptr_t)(dl),						}},    {{	_SHIFTL(G_BRANCH_Z,24,8)|_SHIFTL((vtx)*5,12,12)|_SHIFTL((vtx)*2,0,12),	G_DEPTOZSrg(zval, near, far, flag, zmin, zmax),			}}
 ...
 */
#define	gSPBranchLessZraw(pkt, dl, vtx, zval)				{										Gfx *_g = (Gfx *)(pkt);							_g->words.w0 = _SHIFTL(G_RDPHALF_1,24,8);				_g->words.w1 = (uintptr_t)(dl);					_g = (Gfx *)(pkt);							_g->words.w0 = (_SHIFTL(G_BRANCH_Z,24,8)|					        _SHIFTL((vtx)*5,12,12)|_SHIFTL((vtx)*2,0,12));		_g->words.w1 = (unsigned int)(zval);				}

#define	gsSPBranchLessZraw(dl, vtx, zval)				{{	_SHIFTL(G_RDPHALF_1,24,8),					      	(uintptr_t)(dl),						}},    {{	_SHIFTL(G_BRANCH_Z,24,8)|_SHIFTL((vtx)*5,12,12)|_SHIFTL((vtx)*2,0,12),	(unsigned int)(zval),						}}
 ...
 */
#define	gSPLoadUcodeEx(pkt, uc_start, uc_dstart, uc_dsize)		{										Gfx *_g = (Gfx *)(pkt);							_g->words.w0 = _SHIFTL(G_RDPHALF_1,24,8);				_g->words.w1 = (uintptr_t)(uc_dstart);				_g = (Gfx *)(pkt);							_g->words.w0 = (_SHIFTL(G_LOAD_UCODE,24,8)|						_SHIFTL((int)(uc_dsize)-1,0,16));			_g->words.w1 = (uintptr_t)(uc_start);			}

#define	gsSPLoadUcodeEx(uc_start, uc_dstart, uc_dsize)			{{	_SHIFTL(G_RDPHALF_1,24,8),						(uintptr_t)(uc_dstart),				}},	{{	_SHIFTL(G_LOAD_UCODE,24,8)|						  _SHIFTL((int)(uc_dsize)-1,0,16),					(uintptr_t)(uc_start),				}}
 ...
 */
#define	gSPDma_io(pkt, flag, dmem, dram, size)				{										Gfx *_g = (Gfx *)(pkt);							_g->words.w0 = _SHIFTL(G_DMA_IO,24,8)|_SHIFTL((flag),23,1)|		  _SHIFTL((dmem)/8,13,10)|_SHIFTL((size)-1,0,12);			_g->words.w1 = (uintptr_t)(dram);				}

#define	gsSPDma_io(flag, dmem, dram, size)				{{										_SHIFTL(G_DMA_IO,24,8)|_SHIFTL((flag),23,1)|				_SHIFTL((dmem)/8,13,10)|_SHIFTL((size)-1,0,12),				(uintptr_t)(dram)						}}
...
#else
# define gSPPerspNormalize(pkt, s)					{										Gfx *_g = (Gfx *)(pkt);																_g->words.w0 = _SHIFTL(G_RDPHALF_1, 24, 8);				_g->words.w1 = (s);						}
# define gsSPPerspNormalize(s)						{{										_SHIFTL(G_RDPHALF_1, 24, 8),						(s)								}}
#endif
...
#define	gSetImage(pkt, cmd, fmt, siz, width, i)				{										Gfx *_g = (Gfx *)(pkt);																_g->words.w0 = _SHIFTL(cmd, 24, 8) | _SHIFTL(fmt, 21, 3) |			       _SHIFTL(siz, 19, 2) | _SHIFTL((width)-1, 0, 12);		_g->words.w1 = (uintptr_t)(i);				}

#define	gsSetImage(cmd, fmt, siz, width, i)				{{										_SHIFTL(cmd, 24, 8) | _SHIFTL(fmt, 21, 3) |				_SHIFTL(siz, 19, 2) | _SHIFTL((width)-1, 0, 12),			(uintptr_t)(i)						}}
...
#ifdef F3DEX_GBI_2E
#define	gDPFillRectangle(pkt, ulx, uly, lrx, lry)			{										Gfx *_g0 = (Gfx *)(pkt), *_g1 = (Gfx *)(pkt);				_g0->words.w0 = _SHIFTL(G_FILLRECT, 24, 8) | 					       _SHIFTL((lrx), 2, 22);					_g0->words.w1 = _SHIFTL((lry), 2, 22);				        _g1->words.w0 = _SHIFTL((ulx), 2, 22);					_g1->words.w1 = _SHIFTL((uly), 2, 22);				}
#define	gsDPFillRectangle(ulx, uly, lrx, lry)				{{										(_SHIFTL(G_FILLRECT, 24, 8) | _SHIFTL((lrx), 2, 22)),			_SHIFTL((lry), 2, 22),						}},									{{										_SHIFTL((ulx), 2, 22),							_SHIFTL((uly), 2, 22),						}}
#else
...
#ifdef F3D_OLD
# define gSPTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy){									    Gfx *_g = (Gfx *)(pkt);															    _g->words.w0 = (_SHIFTL(G_TEXRECT, 24, 8) | _SHIFTL(xh, 12, 12) |			    _SHIFTL(yh, 0, 12));    				    _g->words.w1 = (_SHIFTL(tile, 24, 3) | _SHIFTL(xl, 12, 12) |			    _SHIFTL(yl, 0, 12));				    gImmp1(pkt, G_RDPHALF_2, (_SHIFTL(s, 16, 16) | _SHIFTL(t, 0, 16)));	    gImmp1(pkt, G_RDPHALF_CONT, (_SHIFTL(dsdx, 16, 16) | _SHIFTL(dtdy, 0, 16)));}

#define gsSPTextureRectangle(xl, yl, xh, yh, tile, s, t, dsdx, dtdy)	    {{(_SHIFTL(G_TEXRECT, 24, 8) | _SHIFTL(xh, 12, 12) | _SHIFTL(yh, 0, 12)),    (_SHIFTL(tile, 24, 3) | _SHIFTL(xl, 12, 12) | _SHIFTL(yl, 0, 12))}},	    gsImmp1(G_RDPHALF_2, (_SHIFTL(s, 16, 16) | _SHIFTL(t, 0, 16))),	    gsImmp1(G_RDPHALF_CONT, (_SHIFTL(dsdx, 16, 16) | _SHIFTL(dtdy, 0, 16)))

/* like gSPTextureRectangle but accepts negative position arguments */
# define gSPScisTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy) {                                                                                Gfx *_g = (Gfx *)(pkt);                                                                                                                                   _g->words.w0 = (_SHIFTL(G_TEXRECT, 24, 8) |                                                  _SHIFTL(MAX((s16)(xh),0), 12, 12) |                                          _SHIFTL(MAX((s16)(yh),0), 0, 12));                           _g->words.w1 = (_SHIFTL((tile), 24, 3) |                                                     _SHIFTL(MAX((s16)(xl),0), 12, 12) |                                          _SHIFTL(MAX((s16)(yl),0), 0, 12));                           gImmp1(pkt, G_RDPHALF_2,                                                                 (_SHIFTL(((s) -                                                                        (((s16)(xl) < 0) ?                                                            (((s16)(dsdx) < 0) ?                                                          (MAX((((s16)(xl)*(s16)(dsdx))>>7),0)) :          			    (MIN((((s16)(xl)*(s16)(dsdx))>>7),0))) : 0)),    			 16, 16) |                                                            _SHIFTL(((t) -                                                                        (((yl) < 0) ?                                                                 (((s16)(dtdy) < 0) ?                                                          (MAX((((s16)(yl)*(s16)(dtdy))>>7),0)) :                                      (MIN((((s16)(yl)*(s16)(dtdy))>>7),0))) : 0)),    			 0, 16)));                                               gImmp1(pkt, G_RDPHALF_CONT, (_SHIFTL((dsdx), 16, 16) |                                                    _SHIFTL((dtdy), 0, 16)));                      }

# define gsSPTextureRectangleFlip(xl, yl, xh, yh, tile, s, t, dsdx, dtdy)     {{(_SHIFTL(G_TEXRECTFLIP, 24, 8) | _SHIFTL(xh, 12, 12) |		     _SHIFTL(yh, 0, 12)),						    (_SHIFTL(tile, 24, 3) | _SHIFTL(xl, 12, 12) | _SHIFTL(yl, 0, 12))}},	    gsImmp1(G_RDPHALF_2, (_SHIFTL(s, 16, 16) | _SHIFTL(t, 0, 16))),	    gsImmp1(G_RDPHALF_CONT, (_SHIFTL(dsdx, 16, 16) | _SHIFTL(dtdy, 0, 16)))

# define gSPTextureRectangleFlip(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy) {								       	    Gfx *_g = (Gfx *)(pkt);					       										     _g->words.w0 = (_SHIFTL(G_TEXRECTFLIP, 24, 8) | _SHIFTL(xh, 12, 12) |		    _SHIFTL(yh, 0, 12)); 				    _g->words.w1 = (_SHIFTL(tile, 24, 3) | _SHIFTL(xl, 12, 12) |			    _SHIFTL(yl, 0, 12));				    gImmp1(pkt, G_RDPHALF_2, (_SHIFTL(s, 16, 16) | _SHIFTL(t, 0, 16)));	    gImmp1(pkt, G_RDPHALF_CONT, (_SHIFTL(dsdx, 16, 16) | _SHIFTL(dtdy, 0, 16))); }
#elif defined(F3DEX_GBI_2E)
# define gSPTextureRectangle(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy){									    Gfx *_g0 = (Gfx *)(pkt), *_g1 = (Gfx *)(pkt), *_g2 = (Gfx *)(pkt);										    _g0->words.w0 = _SHIFTL(G_TEXRECT, 24, 8) | 					       _SHIFTL((xh), 0, 24);				    _g0->words.w1 = _SHIFTL((yh), 0, 24);				    _g1->words.w0 = (_SHIFTL(tile, 24, 3) | _SHIFTL((xl), 0, 24));	    _g1->words.w1 = _SHIFTL((yl), 0, 24);				    _g2->words.w0 = (_SHIFTL(s, 16, 16) | _SHIFTL(t, 0, 16));		    _g2->words.w1 = (_SHIFTL(dsdx, 16, 16) | _SHIFTL(dtdy, 0, 16));	}

# define gsSPTextureRectangle(xl, yl, xh, yh, tile, s, t, dsdx, dtdy)	{{									    (_SHIFTL(G_TEXRECT, 24, 8) | _SHIFTL((xh), 0, 24)),			    _SHIFTL((yh), 0, 24),						}},									{{									    (_SHIFTL((tile), 24, 3) | _SHIFTL((xl), 0, 24)),			    _SHIFTL((yl), 0, 24),						}},									{{									    _SHIFTL(s, 16, 16) | _SHIFTL(t, 0, 16),				    _SHIFTL(dsdx, 16, 16) | _SHIFTL(dtdy, 0, 16)			}}

# define gSPTextureRectangleFlip(pkt, xl, yl, xh, yh, tile, s, t, dsdx, dtdy) {									    Gfx *_g0 = (Gfx *)(pkt), *_g1 = (Gfx *)(pkt), *_g2 = (Gfx *)(pkt);										    _g0->words.w0 = _SHIFTL(G_TEXRECTFLIP, 24, 8) | 					       _SHIFTL((xh), 0, 24);				    _g0->words.w1 = _SHIFTL((yh), 0, 24);				    _g1->words.w0 = (_SHIFTL(tile, 24, 3) | _SHIFTL((xl), 0, 24));	    _g1->words.w1 = _SHIFTL((yl), 0, 24);				    _g2->words.w0 = (_SHIFTL(s, 16, 16) | _SHIFTL(t, 0, 16));		    _g2->words.w1 = (_SHIFTL(dsdx, 16, 16) | _SHIFTL(dtdy, 0, 16));	}
#else
...
#define gDPWord(pkt, wordhi, wordlo)      		{							    Gfx *_g = (Gfx *)(pkt);											    gImmp1(pkt, G_RDPHALF_1, (uintptr_t)(wordhi));	    gImmp1(pkt, G_RDPHALF_2, (uintptr_t)(wordlo));	}

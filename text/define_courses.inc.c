#define COURSE_ACTS(id, name, a,b,c,d,e,f)     static const u8 GLUE2(COURSE_TABLE, _ ## id)[] = { name };

#define SECRET_STAR(id, name)     static const u8 GLUE2(COURSE_TABLE, _ ## id)[] = { name };

#define CASTLE_SECRET_STARS(str)     static const u8 GLUE2(COURSE_TABLE, _castle_secret_stars)[] = { str };

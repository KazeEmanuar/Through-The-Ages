...
#else
#define M64_READ_U8(state, dst) {                                   u8 * _ptr_pc;                   u8  _pc;                        _ptr_pc = (*state).pc;          ((*state).pc)++;                _pc = *_ptr_pc;                 dst = _pc;                  }
#endif

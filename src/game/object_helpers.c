...
u8 doesCloudExist() {
    uintptr_t *behaviorAddr = segmented_to_virtual(bhvHuffPuff);
...
struct Object *find_obj_with_bparam(const BehaviorScript *behavior, u32 bParam) {
    uintptr_t *behaviorAddr = segmented_to_virtual(behavior);
    struct Object *obj;
    struct ObjectNode *listHead;
    f32 minDist = 0x20000;

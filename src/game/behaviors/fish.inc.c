...
void fish_act_spawn(void) {
    ...
    switch (o->oBehParams2ndByte) {
        ...
        case 0:
            model = MODEL_FISH;    schoolQuantity = 8;    minDistToMario = 150000.0f;    fishAnimation = blue_fish_seg3_anims_0301C2B0;
            break;
            
        // Blue fish with a quanitiy of five.
        case 1:
            model = MODEL_FISH;    schoolQuantity = 5;    minDistToMario = 150000.0f;    fishAnimation = blue_fish_seg3_anims_0301C2B0;
            break;
            
        // Cyan fish with a quanitiy of twenty.
        case 2:
            model = MODEL_CYAN_FISH;    schoolQuantity = 20;    minDistToMario = 150000.0f;    fishAnimation = cyan_fish_seg6_anims_0600E264;
            break;
            
        // Cyan fish with a quanitiy of five.
        case 3:
            model = MODEL_CYAN_FISH;    schoolQuantity = 5;    minDistToMario = 150000.0f;    fishAnimation = cyan_fish_seg6_anims_0600E264;
            break;
        case 4:
            model = MODEL_FISH;    schoolQuantity = 15;    minDistToMario = 150000.0f;    fishAnimation = blue_fish_seg3_anims_0301C2B0;
            break;
    }
    /**
...
void fish_act_respawn(void) {
    if (gCurrLevelNum != LEVEL_SA) {
        if (gMarioObject->oPosY - o->oPosY > 20000.0f) {
...
void fish_group_act_rotation(void) {
    ...
    if (o->oTimer == 0) {
        ...
        o->oFishRespawnDistance = random_float() * 5000 + 2000.0f;
    }
...
void fish_group_act_move(void) {
     ...
     */
    if (o->oTimer == 0) {
        o->oFishActiveDistance = random_float() * 3000.0f;
    ...
    if (o->oDistanceToMario > o->oFishActiveDistance + 5000.0f) {
        o->oAction = FISH_ACT_ACTIVE;
    }
}
/**
...
void fish_group_act_animate(void) {
    ...
    o->oFishDepthDistance = random_float() * 3000.0f;
